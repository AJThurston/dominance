...
res$var <- res$var %>%
  factor(., levels = c("sa","personality","o","c","e","a","n","gma","demographic","sex","eth","race","age","tenure"))
...
p.title <- "Incremental validity of Situation Awareness in predicting Safety Performance" # Plot title
s.title <- NA
l.title <- "Predictors" # Legend Title
x.title <- "Percentage of R2 accounted for by predictor" #X-axis title
...
p <- ggplot(res %>% filter(total != "total"))
